          ...
          >
            <div class="row">
              <div class="col-12 col-lg-7">
                ...
                >
                  <swiper-slide
                    v-for="(url, index) in roomsData.imageUrlList"
                    :key="index"
                  >
                    <picture>
                      <source
              ...
              <div class="col-12 col-lg-5">
                <div class="card-body pe-md-10 py-md-10">
                  ...
                  <div class="d-flex justify-content-between align-items-center fs-7 fs-md-5 text-primary-100">
                    ...
                    <p v-priceformat:TWD="roomsData.price" class="mb-0 fw-bold"></p>
                    <NuxtLink
                      :to="`/rooms/${roomsData._id}`"
